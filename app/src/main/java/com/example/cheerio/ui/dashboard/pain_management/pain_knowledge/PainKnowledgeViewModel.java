...
public class PainKnowledgeViewModel extends ViewModel implements Data_load_listener {
    private MutableLiveData<List<Data_model>> mutableDataList;
    private MutableLiveData<String> errorMessage = new MutableLiveData<>();
    private Data_load_listener data_load_listener;

    public PainKnowledgeViewModel() {
    ...
    private void loadData() {
        ...
        FirebaseFirestore.getInstance().collection("Pain Knowledge")
