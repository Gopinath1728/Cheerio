...
public class ExerciseDataViewModel extends ViewModel implements Data_load_listener {
    ...
    public MutableLiveData<List<Data_model>> getMutableDataList(String name) {
